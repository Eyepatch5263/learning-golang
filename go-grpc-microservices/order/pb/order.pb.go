...
type PostOrderRequest struct {
	...
	Products      []*PostOrderRequest_OrderedProduct `protobuf:"bytes,4,rep,name=products,proto3" json:"products,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_order_proto_rawDesc = "" +
	...
	"\bproducts\x18\x04 \x03(\v2#.pb.PostOrderRequest.OrderedProductR\bproducts\x1aJ\n" +
